...
from .views import ProductViewSet, WishlistAPIView, BrandViewSet, CategoryViewSet, CartSummaryAPIView, CartItemAPIView, \
    BrandTierAPIView, ListTiersAPIView, CheckoutAPIView
...
urlpatterns = [
    ...
    # /products/ and /products/<id>/ , /brands/ and /brands/<id>/  , /categories/ and /categories/<id>/
    ...
    # Post Checkout endpoint (handles cupons and user points)
